...
const models: Model[] = [
  { id: 'llama', name: 'Llama3.2-vision', description: 'Meta\'s vision-language model' },
  { id: 'moondream', name: 'Moondream2', description: 'Lightweight vision-language model' },
